...
function [peaks] = get_signals_metrics(dataRoot,simuRoot,stationName,stationNumber,doPlot,hf)
...
for i=1:3
    ...
    [disMaxT(1,i),disMax(1,i)] = find_maximum(dataDis(:,i),dataDT);
    [disMaxT(2,i),disMax(2,i)] = find_maximum(simuDis(:,i),simuDT);   
end
